...
var App = function() {
    ...
    var uiHelperMaskedInputs = function(){
        ...
        jQuery('.js-masked-phone').mask('(+999) 99-999-9999');
        jQuery('.js-masked-phone-ext').mask('(999) 999-9999? x99999');
        jQuery('.js-masked-taxid').mask('99-9999999');
        jQuery('.js-masked-ssn').mask('999-99-9999');
        jQuery('.js-masked-pkey').mask('a*-999-a999');
        jQuery('.js-masked-serial').mask('a*-9999999');
    };
...
//
//             // The preview image
//             var picker_preview_image = $('<img src="'+src+'" class="img-responsive img-rounded" id="images1" />');
//
//             // The remove image button
//             var picker_preview_remove = $('<button class="btn btn-link"><small><i class="fa fa-remove "></i></small></button>');
//
//             // The preview element
...
//     $('.img-picker').imagePicker({name: 'images1'});
// })
